...
/* STM32H7 uses AHB4ENR for GPIO clocks (not AHB1ENR like F4) */
#define PORT_ENABLE_CLOCK(...)\
do{\
  __IO uint32_t tmp;\
  VA_MACRO(PORT_ENABLE_CLOCK, __VA_ARGS__);\
  /* readback for clock stabilization */\
  tmp = RCC->AHB4ENR;\
  (void)tmp;\
}while(0)

#define PORT_ENABLE_CLOCK1(_1)                                  RCC->AHB4ENR |= RCC_AHB4ENR_GPIO##_1##EN
#define PORT_ENABLE_CLOCK2(_1, _2)                              RCC->AHB4ENR |= RCC_AHB4ENR_GPIO##_1##EN |\
                                                                                RCC_AHB4ENR_GPIO##_2##EN
#define PORT_ENABLE_CLOCK3(_1, _2, _3)                          RCC->AHB4ENR |= RCC_AHB4ENR_GPIO##_1##EN |\
                                                                                RCC_AHB4ENR_GPIO##_2##EN |\
                                                                                RCC_AHB4ENR_GPIO##_3##EN
#define PORT_ENABLE_CLOCK4(_1, _2, _3, _4)                      RCC->AHB4ENR |= RCC_AHB4ENR_GPIO##_1##EN |\
                                                                                RCC_AHB4ENR_GPIO##_2##EN |\
                                                                                RCC_AHB4ENR_GPIO##_3##EN |\
                                                                                RCC_AHB4ENR_GPIO##_4##EN

#define PORT_ENABLE_CLOCK5(_1, _2, _3, _4, _5)                  RCC->AHB4ENR |= RCC_AHB4ENR_GPIO##_1##EN |\
                                                                                RCC_AHB4ENR_GPIO##_2##EN |\
                                                                                RCC_AHB4ENR_GPIO##_3##EN |\
                                                                                RCC_AHB4ENR_GPIO##_4##EN |\
                                                                                RCC_AHB4ENR_GPIO##_5##EN

#define PORT_ENABLE_CLOCK6(_1, _2, _3, _4, _5, _6)              RCC->AHB4ENR |= RCC_AHB4ENR_GPIO##_1##EN |\
                                                                                RCC_AHB4ENR_GPIO##_2##EN |\
                                                                                RCC_AHB4ENR_GPIO##_3##EN |\
                                                                                RCC_AHB4ENR_GPIO##_4##EN |\
                                                                                RCC_AHB4ENR_GPIO##_5##EN |\
                                                                                RCC_AHB4ENR_GPIO##_6##EN

#define PORT_ENABLE_CLOCK7(_1, _2, _3, _4, _5, _6, _7)          RCC->AHB4ENR |= RCC_AHB4ENR_GPIO##_1##EN |\
                                                                                RCC_AHB4ENR_GPIO##_2##EN |\
                                                                                RCC_AHB4ENR_GPIO##_3##EN |\
                                                                                RCC_AHB4ENR_GPIO##_4##EN |\
                                                                                RCC_AHB4ENR_GPIO##_5##EN |\
                                                                                RCC_AHB4ENR_GPIO##_6##EN |\
                                                                                RCC_AHB4ENR_GPIO##_7##EN

#define PORT_ENABLE_CLOCK8(_1, _2, _3, _4, _5, _6, _7, _8)      RCC->AHB4ENR |= RCC_AHB4ENR_GPIO##_1##EN |\
                                                                                RCC_AHB4ENR_GPIO##_2##EN |\
                                                                                RCC_AHB4ENR_GPIO##_3##EN |\
                                                                                RCC_AHB4ENR_GPIO##_4##EN |\
                                                                                RCC_AHB4ENR_GPIO##_5##EN |\
