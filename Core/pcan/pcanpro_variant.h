...
/* FDCAN2 pins - using AF9_FDCAN2 for STM32H7 */
#define CAN2_RX       B, 5, MODE_AF_PP, PULLUP, SPEED_FREQ_VERY_HIGH, AF9_FDCAN2
#define CAN2_TX       B, 6, MODE_AF_PP, NOPULL, SPEED_FREQ_VERY_HIGH, AF9_FDCAN2
...
/* LEDs - Red, Blue, Green */
#define IO_LED_STAT   C, 10, MODE_OUTPUT_PP, NOPULL, SPEED_FREQ_MEDIUM, NOAF  /* red */
#define IO_LED_TX0    E, 0, MODE_OUTPUT_PP, NOPULL, SPEED_FREQ_MEDIUM, NOAF   /* blue */
#define IO_LED_RX0    B, 9, MODE_OUTPUT_PP, NOPULL, SPEED_FREQ_MEDIUM, NOAF   /* green */
...
/* Hardware initialization */
#define IO_HW_INIT()
// If using transceiver standby pins:
// #define IO_HW_INIT()  PORT_ENABLE_CLOCK( PIN_PORT( CAN1_S ), PIN_PORT( CAN2_S ) );\
//                       PIN_LOW( CAN1_S );\
//                       PIN_LOW( CAN2_S );\
//                       PIN_INIT( CAN1_S );\
//                       PIN_INIT( CAN2_S )
...
#else
#error "Invalid hardware variant! Define one of: DEVEBOX_H743, NUCLEO_H743, HEXV2_CLONE_H7, CUSTOM_H743, EMPTY_STUB"
#endif
 ...
 * - TX: PA15, PF7
 * 
 * Note: Always verify pin availability for your specific package (LQFP100, LQFP144, etc.)
 */