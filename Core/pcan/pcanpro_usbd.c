...
// #endif
// __ALIGN_BEGIN static const USB_DEVICE_QUALIFIER_DESCRIPTOR dev_qua
//     __ALIGN_END = {
...
// #pragma data_alignment = 4
// #endif
// __ALIGN_BEGIN static struct t_pcanpro_description pcanpro_dev
//     __ALIGN_END = {.con0 =
//                        {
...
//                            .bDescriptorType = USB_ENDPOINT_DESCRIPTOR_TYPE,
//                            .bEndpointAddress =
//                                PCAN_USB_EP_MSGIN_CH2, /* not used */
//                            .bmAttributes = USB_ENDPOINT_TYPE_BULK,
//                            .wMaxPacketSize = 64, /* FS: 64, HS: 512 */
//                            .bInterval = 0,
//                        },
...
//   USBD_LL_PrepareReceive(pdev, PCAN_USB_EP_CMDOUT, pcanpro_data.cmd_ep_buffer,
//                          sizeof(pcanpro_data.cmd_ep_buffer));
//   USBD_LL_PrepareReceive(pdev, PCAN_USB_EP_MSGOUT_CH1,
//                          pcanpro_data.data1_ep_buffer,
//                          sizeof(pcanpro_data.data1_ep_buffer));
//   USBD_LL_PrepareReceive(pdev, PCAN_USB_EP_MSGOUT_CH2,
//                          pcanpro_data.data2_ep_buffer,
//                          sizeof(pcanpro_data.data2_ep_buffer));
...
//   printf("USB: Data IN (RX Okay) EP=0x%02X\r\n", epnum);
...
// static uint8_t *device_get_user_string(USBD_HandleTypeDef *pdev, uint8_t index,
//                                        uint16_t *length) {
