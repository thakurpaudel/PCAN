...
#define PCAN_NUM_CHANNELS (2)
#define PCAN_FIRMWARE_VERSION_MAJOR 3
#define PCAN_FIRMWARE_VERSION_MINOR 5
#define PCAN_FIRMWARE_VERSION_PATCH 3
#define PCAN_USB_BCD_DEVICE 0x0353
...
#define PCAN_FIRMWARE_VERSION_MAJOR 3
#define PCAN_FIRMWARE_VERSION_MINOR 5
#define PCAN_FIRMWARE_VERSION_PATCH 1
#define PCAN_USB_BCD_DEVICE 0x0351
...
#ifndef PCAN_FIRMWARE_VERSION_MAJOR
#define PCAN_FIRMWARE_VERSION_MAJOR 1
#define PCAN_FIRMWARE_VERSION_MINOR 3
#define PCAN_FIRMWARE_VERSION_PATCH 3
#define PCAN_USB_BCD_DEVICE 0x0133
#endif
